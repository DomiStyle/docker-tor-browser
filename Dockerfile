...
ENV APP_NAME="Tor Browser" \
    TOR_VERSION=9.5.1 \
    TOR_BINARY=https://www.torproject.org/dist/torbrowser/9.5.1/tor-browser-linux64-9.5.1_en-US.tar.xz \
    TOR_SIGNATURE=https://www.torproject.org/dist/torbrowser/9.5.1/tor-browser-linux64-9.5.1_en-US.tar.xz.asc \
